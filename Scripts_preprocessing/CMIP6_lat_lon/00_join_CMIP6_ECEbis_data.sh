...
# for VAR in pr #tas #hus850 hus925 ts ua200 ua850 va200 va850 wap500 wap850 zg
# do
...
#         do
#             INPUT=~/shared_data/volume_2/bbrotonsbl/resampling/Method-2014/data_symlinks_new/pr/ #INPUT_${VAR} #/data/brotons/resampling/Method-2014/data_symlinks/tas/
#             OUTPUT=~/shared_data/volume_2/bbrotonsbl/resampling/Method-2014/preprocessed_data/CMIP6/00_join_CMIP6_models/${VAR}/
#             cdo mergetime ${INPUT}${VAR}_mon_${MODEL}_historical_*.nc ${INPUT}${VAR}_mon_${MODEL}_ssp${SSP}_*.nc ${OUTPUT}${MODEL}_Amon_historical-ssp${SSP}_185001-210012_${VAR}.nc
#         done
#     done
# done
...
# for VAR in tas #hus850 hus925 #tas tas ts ua200 ua850 va200 va850 wap500 wap850 zg
# do
#     for MODEL in ACCESS-CM2 ACCESS-ESM1-5 AWI-CM-1-1-MR BCC-CSM2-MR CanESM5 CanESM5-CanOE CESM2 CESM2-WACCM CIESM CMCC-CM2-SR5 CNRM-CM6-1 CNRM-CM6-1-HR CNRM-ESM2-1 EC-Earth3 EC-Earth3-Veg FGOALS-f3-L FGOALS-g3 GFDL-ESM4 GISS-E2-1-G HadGEM3-GC31-LL INM-CM4-8  INM-CM5-0 IPSL-CM6A-LR KACE-1-0-G MIROC6 MIROC-ES2L MPI-ESM1-2-HR MPI-ESM1-2-LR MRI-ESM2-0 NESM3 NorESM2-MM UKESM1-0-LL 
#     do
#         for SSP in 585 #585MODEL in CanESM5 CanESM5-CanOE
#         do
#             INPUT=~/shared_data/volume_2/bbrotonsbl/resampling/Method-2014/data_symlinks_new/tas/ #INPUT_${VAR} #/data/brotons/resampling/Method-2014/data_symlinks/tas/
#             OUTPUT=~/shared_data/volume_2/bbrotonsbl/resampling/Method-2014/preprocessed_data/CMIP6/00_join_CMIP6_models/${VAR}/
#             cdo mergetime ${INPUT}${VAR}_mon_${MODEL}_historical_*.nc ${INPUT}${VAR}_mon_${MODEL}_ssp${SSP}_*.nc ${OUTPUT}${MODEL}_Amon_historical-ssp${SSP}_185001-210012_${VAR}.nc
#         done
#     done
...
# for VAR in psl #hus850 hus925 #tas tas ts ua200 ua850 va200 va850 wap500 wap850 zg
# do
#     for MODEL in ACCESS-CM2 ACCESS-ESM1-5 AWI-CM-1-1-MR BCC-CSM2-MR CanESM5 CanESM5-CanOE CESM2 CESM2-WACCM CIESM CMCC-CM2-SR5 CNRM-CM6-1 CNRM-CM6-1-HR CNRM-ESM2-1 EC-Earth3 EC-Earth3-Veg FGOALS-f3-L FGOALS-g3 GFDL-ESM4 GISS-E2-1-G HadGEM3-GC31-LL INM-CM4-8  INM-CM5-0 IPSL-CM6A-LR KACE-1-0-G MIROC6 MIROC-ES2L MPI-ESM1-2-HR MPI-ESM1-2-LR MRI-ESM2-0 NESM3 NorESM2-MM UKESM1-0-LL 
#     do
#         for SSP in 585 #585MODEL in CanESM5 CanESM5-CanOE
#         do
#             INPUT=~/shared_data/volume_2/bbrotonsbl/resampling/Method-2014/data_symlinks_new/psl/ #INPUT_${VAR} #/data/brotons/resampling/Method-2014/data_symlinks/tas/
#             OUTPUT=~/shared_data/volume_2/bbrotonsbl/resampling/Method-2014/preprocessed_data/CMIP6/00_join_CMIP6_models/${VAR}/
#             cdo mergetime ${INPUT}${VAR}_mon_${MODEL}_historical_*.nc ${INPUT}${VAR}_mon_${MODEL}_ssp${SSP}_*.nc ${OUTPUT}${MODEL}_Amon_historical-ssp${SSP}_185001-210012_${VAR}.nc
#         done
#     done
...
# for VAR in hfls #hus850 hus925 #pr tas ts ua200 ua850 va200 va850 wap500 wap850 zg
# do
#     for MODEL in ACCESS-CM2 ACCESS-ESM1-5 AWI-CM-1-1-MR BCC-CSM2-MR CanESM5 CanESM5-CanOE CESM2 CESM2-WACCM CIESM CMCC-CM2-SR5 CNRM-CM6-1 CNRM-CM6-1-HR CNRM-ESM2-1 EC-Earth3 EC-Earth3-Veg FGOALS-f3-L FGOALS-g3 GFDL-ESM4 GISS-E2-1-G HadGEM3-GC31-LL INM-CM4-8  INM-CM5-0 IPSL-CM6A-LR KACE-1-0-G MIROC6 MIROC-ES2L MPI-ESM1-2-HR MPI-ESM1-2-LR MRI-ESM2-0 NESM3 NorESM2-MM UKESM1-0-LL 
#     do
#         for SSP in 585 #585MODEL in CanESM5 CanESM5-CanOE
#         do
#             INPUT=~/shared_data/volume_2/rhaarsma/DATA_MARTA/CMIP6_data/hfls/ #INPUT_${VAR} #/data/brotons/resampling/Method-2014/data_symlinks/tas/
#             OUTPUT=~/shared_data/volume_2/bbrotonsbl/resampling/Method-2014/preprocessed_data/CMIP6/00_join_CMIP6_models/${VAR}/
#             cdo mergetime ${INPUT}${VAR}_Amon_${MODEL}_historical_*195001-201412.nc ${INPUT}${VAR}_Amon_${MODEL}_ssp${SSP}_*.nc ${OUTPUT}${MODEL}_Amon_historical-ssp${SSP}_195001-210012_${VAR}.nc
#         done
#     done
# done
...
# for VAR in hus700 #ua200 ua850 va200 va850 wap500 wap850 zg
# do
#     for MODEL in ACCESS-CM2 ACCESS-ESM1-5 AWI-CM-1-1-MR BCC-CSM2-MR CanESM5 CanESM5-CanOE CESM2 CESM2-WACCM CIESM CMCC-CM2-SR5 CNRM-CM6-1 CNRM-CM6-1-HR CNRM-ESM2-1 EC-Earth3 EC-Earth3-Veg FGOALS-f3-L FGOALS-g3 GFDL-ESM4 GISS-E2-1-G HadGEM3-GC31-LL INM-CM4-8  INM-CM5-0 IPSL-CM6A-LR KACE-1-0-G MIROC6 MIROC-ES2L MPI-ESM1-2-HR MPI-ESM1-2-LR MRI-ESM2-0 NESM3 NorESM2-MM UKESM1-0-LL 
#     do
#         for SSP in 585 #585MODEL in CanESM5 CanESM5-CanOE
#         do
#             INPUT=~/shared_data/volume_2/rhaarsma/DATA_MARTA/CMIP6_data/hus/ 
#             OUTPUT=~/shared_data/volume_2/bbrotonsbl/resampling/Method-2014/preprocessed_data/CMIP6/00_join_CMIP6_models/${VAR}/
#             cdo mergetime ${INPUT}${VAR}_Amon_${MODEL}_historical_*195001-201412.nc ${INPUT}${VAR}_Amon_${MODEL}_ssp${SSP}_*.nc ${OUTPUT}${MODEL}_Amon_historical-ssp${SSP}_195001-210012_${VAR}.nc
#         done
#     done
...
# for VAR in hus1000 #ua200 ua850 va200 va850 wap500 wap850 zg
# do
#     for MODEL in ACCESS-CM2 ACCESS-ESM1-5 AWI-CM-1-1-MR BCC-CSM2-MR CanESM5 CanESM5-CanOE CESM2 CESM2-WACCM CIESM CMCC-CM2-SR5 CNRM-CM6-1 CNRM-CM6-1-HR CNRM-ESM2-1 EC-Earth3 EC-Earth3-Veg FGOALS-f3-L FGOALS-g3 GFDL-ESM4 GISS-E2-1-G HadGEM3-GC31-LL INM-CM4-8  INM-CM5-0 IPSL-CM6A-LR KACE-1-0-G MIROC6 MIROC-ES2L MPI-ESM1-2-HR MPI-ESM1-2-LR MRI-ESM2-0 NESM3 NorESM2-MM UKESM1-0-LL 
#     do
#         for SSP in 585 #585MODEL in CanESM5 CanESM5-CanOE
...
for VAR in ua1000 #ua200 ua850 va200 va850 wap500 wap850 zg
do
    for MODEL in ACCESS-CM2 ACCESS-ESM1-5 AWI-CM-1-1-MR BCC-CSM2-MR CanESM5 CanESM5-CanOE CESM2 CESM2-WACCM CIESM CMCC-CM2-SR5 CNRM-CM6-1 CNRM-CM6-1-HR CNRM-ESM2-1 EC-Earth3 EC-Earth3-Veg FGOALS-f3-L FGOALS-g3 GFDL-ESM4 GISS-E2-1-G HadGEM3-GC31-LL INM-CM4-8  INM-CM5-0 IPSL-CM6A-LR KACE-1-0-G MIROC6 MIROC-ES2L MPI-ESM1-2-HR MPI-ESM1-2-LR MRI-ESM2-0 NESM3 NorESM2-MM UKESM1-0-LL 
    do
        for SSP in 585 #585MODEL in CanESM5 CanESM5-CanOE
        do
            INPUT=~/shared_data/volume_2/rhaarsma/DATA_MARTA/CMIP6_data/ua/ 
            OUTPUT=~/shared_data/volume_2/bbrotonsbl/resampling/Method-2014/preprocessed_data/CMIP6/00_join_CMIP6_models/${VAR}/
            cdo mergetime ${INPUT}${VAR}_Amon_${MODEL}_historical_*195001-201412.nc ${INPUT}${VAR}_Amon_${MODEL}_ssp${SSP}_*.nc ${OUTPUT}${MODEL}_Amon_historical-ssp${SSP}_195001-210012_${VAR}.nc
        done
    done
...
for VAR in ua925 #ua200 ua850 va200 va850 wap500 wap850 zg
do
    for MODEL in ACCESS-CM2 ACCESS-ESM1-5 AWI-CM-1-1-MR BCC-CSM2-MR CanESM5 CanESM5-CanOE CESM2 CESM2-WACCM CIESM CMCC-CM2-SR5 CNRM-CM6-1 CNRM-CM6-1-HR CNRM-ESM2-1 EC-Earth3 EC-Earth3-Veg FGOALS-f3-L FGOALS-g3 GFDL-ESM4 GISS-E2-1-G HadGEM3-GC31-LL INM-CM4-8  INM-CM5-0 IPSL-CM6A-LR KACE-1-0-G MIROC6 MIROC-ES2L MPI-ESM1-2-HR MPI-ESM1-2-LR MRI-ESM2-0 NESM3 NorESM2-MM UKESM1-0-LL 
    do
        for SSP in 585 #585MODEL in CanESM5 CanESM5-CanOE
...
for VAR in ua700 #va200 va850 va200 va850 wap500 wap850 zg
do
    for MODEL in ACCESS-CM2 ACCESS-ESM1-5 AWI-CM-1-1-MR BCC-CSM2-MR CanESM5 CanESM5-CanOE CESM2 CESM2-WACCM CIESM CMCC-CM2-SR5 CNRM-CM6-1 CNRM-CM6-1-HR CNRM-ESM2-1 EC-Earth3 EC-Earth3-Veg FGOALS-f3-L FGOALS-g3 GFDL-ESM4 GISS-E2-1-G HadGEM3-GC31-LL INM-CM4-8  INM-CM5-0 IPSL-CM6A-LR KACE-1-0-G MIROC6 MIROC-ES2L MPI-ESM1-2-HR MPI-ESM1-2-LR MRI-ESM2-0 NESM3 NorESM2-MM UKESM1-0-LL 
    do
        for SSP in 585 #585MODEL in CanESM5 CanESM5-CanOE
...
for VAR in va1000 #va200 va850 va200 va850 wap500 wap850 zg
do
    for MODEL in ACCESS-CM2 ACCESS-ESM1-5 AWI-CM-1-1-MR BCC-CSM2-MR CanESM5 CanESM5-CanOE CESM2 CESM2-WACCM CIESM CMCC-CM2-SR5 CNRM-CM6-1 CNRM-CM6-1-HR CNRM-ESM2-1 EC-Earth3 EC-Earth3-Veg FGOALS-f3-L FGOALS-g3 GFDL-ESM4 GISS-E2-1-G HadGEM3-GC31-LL INM-CM4-8  INM-CM5-0 IPSL-CM6A-LR KACE-1-0-G MIROC6 MIROC-ES2L MPI-ESM1-2-HR MPI-ESM1-2-LR MRI-ESM2-0 NESM3 NorESM2-MM UKESM1-0-LL 
    do
        for SSP in 585 #585MODEL in CanESM5 CanESM5-CanOE
        do
            INPUT=~/shared_data/volume_2/rhaarsma/DATA_MARTA/CMIP6_data/va/ 
            OUTPUT=~/shared_data/volume_2/bbrotonsbl/resampling/Method-2014/preprocessed_data/CMIP6/00_join_CMIP6_models/${VAR}/
            cdo mergetime ${INPUT}${VAR}_Amon_${MODEL}_historical_*195001-201412.nc ${INPUT}${VAR}_Amon_${MODEL}_ssp${SSP}_*.nc ${OUTPUT}${MODEL}_Amon_historical-ssp${SSP}_195001-210012_${VAR}.nc
        done
    done
...
for VAR in va925 #va200 va850 va200 va850 wap500 wap850 zg
do
    for MODEL in ACCESS-CM2 ACCESS-ESM1-5 AWI-CM-1-1-MR BCC-CSM2-MR CanESM5 CanESM5-CanOE CESM2 CESM2-WACCM CIESM CMCC-CM2-SR5 CNRM-CM6-1 CNRM-CM6-1-HR CNRM-ESM2-1 EC-Earth3 EC-Earth3-Veg FGOALS-f3-L FGOALS-g3 GFDL-ESM4 GISS-E2-1-G HadGEM3-GC31-LL INM-CM4-8  INM-CM5-0 IPSL-CM6A-LR KACE-1-0-G MIROC6 MIROC-ES2L MPI-ESM1-2-HR MPI-ESM1-2-LR MRI-ESM2-0 NESM3 NorESM2-MM UKESM1-0-LL 
    do
        for SSP in 585 #585MODEL in CanESM5 CanESM5-CanOE
...
for VAR in va700 #va200 va850 va200 va850 wap500 wap850 zg
do
    for MODEL in ACCESS-CM2 ACCESS-ESM1-5 AWI-CM-1-1-MR BCC-CSM2-MR CanESM5 CanESM5-CanOE CESM2 CESM2-WACCM CIESM CMCC-CM2-SR5 CNRM-CM6-1 CNRM-CM6-1-HR CNRM-ESM2-1 EC-Earth3 EC-Earth3-Veg FGOALS-f3-L FGOALS-g3 GFDL-ESM4 GISS-E2-1-G HadGEM3-GC31-LL INM-CM4-8  INM-CM5-0 IPSL-CM6A-LR KACE-1-0-G MIROC6 MIROC-ES2L MPI-ESM1-2-HR MPI-ESM1-2-LR MRI-ESM2-0 NESM3 NorESM2-MM UKESM1-0-LL 
    do
        for SSP in 585 #585MODEL in CanESM5 CanESM5-CanOE
